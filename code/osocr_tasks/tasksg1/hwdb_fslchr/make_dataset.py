...
def splithwdbtr(trfulldbdst, tefulldbdst, name,
    ...
    build_training_dataset_by_label([trfulldbdst, tefulldbdst], dstroot, train, ["image"], ["label", "lang", "wrid"],
                                    "label", name);
...
def splithwdb_test(trfulldbdst, tefulldbdst, compdbdst, name,
    ...
    build_testing_dataset_by_label([tefulldbdst], dstroot, val, eval, ["image"], ["label", "lang", "wrid"], "label",
                                   "cuws_eval" + name, "cuws_val" + name);
    build_testing_dataset_by_label([compdbdst], dstroot, val, eval, ["image"], ["label", "lang", "wrid"], "label",
                                   "cuwu_eval" + name, "cuwu_val" + name);
